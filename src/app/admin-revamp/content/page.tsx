  ...
  return (
    <div>
      <div className="d-flex justify-content-between align-items-center mb-3">
        ...
        <Link href="/admin-revamp/content/new" className="btn btn-primary">New content</Link>
      </div>
              ...
              {entries.map((e) => (
                <tr key={e.id}>
                  ...
                  <td className="text-end">
                    <Link href={`/admin-revamp/content/${e.id}`} className="btn btn-sm btn-outline-secondary me-2">Edit</Link>
